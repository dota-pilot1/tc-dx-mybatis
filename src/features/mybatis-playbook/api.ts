...
export function aiEditArchitectureDocument(id: string, body: { content: string; instruction: string }) { return request<{ content: string }>(`/mybatis-playbook/documents/${id}/ai-edit`, { method: "POST", body, errorMessage: "AI 편집에 실패했습니다." }); }
