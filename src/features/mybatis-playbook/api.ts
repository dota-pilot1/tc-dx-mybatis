...
export function aiEditArchitectureDocument(id: string, body: { content: string; instruction: string }) { return request<{ content: string }>(`/mybatis-playbook/documents/${id}/ai-edit`, { method: "POST", body, timeoutMs: 90_000, errorMessage: "AI 편집 요청에 실패했습니다. 잠시 후 다시 시도해 주세요." }); }
