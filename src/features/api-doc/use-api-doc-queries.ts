...
import { apiDocApi } from "./api-doc-api";
import type {
  ApiBlockContent,
...
import type { ApiDocImportExportFile } from "./import-export-types";
...
export function useDeleteApiDocTeam() {
  ...
  return useMutation({
    ...
    onSuccess: async () => {
      await queryClient.invalidateQueries({ queryKey: apiDocQueryKeys.teams });
